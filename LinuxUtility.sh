...
declare -a getsatastoragedrives=()
declare -a satastoragedrives=()
declare -a satastorageids=()
declare -a satastoragesdx=()

declare -a getnvmestoragedrives=()
declare -a nvmestoragedrives=()
declare -a nvmestorageids=()
declare -a nvmestoragesdx=()

declare -a getusbstoragedrives=()
declare -a usbstoragedrives=()
declare -a usbstorageids=()
declare -a usbstoragesdx=()
